...
The image below is stored as **GIF** so GitHub can render it in the README. For a **full animated** walkthrough (mouse movement, typing, payment step-up), export your screen recording as GIF.
